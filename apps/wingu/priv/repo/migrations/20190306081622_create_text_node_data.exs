defmodule Wingu.Repo.Migrations.CreateTextNodeData do
  ...
  def change do
    create table(:text_node_data, primary_key: false) do
      ...
      add :node_value, :text
      add :description_nodes_id, references(:description_nodes, on_delete: :delete_all, type: :binary_id)
      add :section_data_id, references(:section_data, on_delete: :delete_all, type: :binary_id)
