defmodule WinguWeb.Endpoint do
  ...
  plug Plug.Static,
    ...
    from: :wingu_web,
    gzip: false,
    only: ~w(css fonts images js favicon.ico robots.txt manifest.json favicon-32x32.png favicon-16x16.png favicon-96x96.png android-icon-192x192.png apple-icon-114x114.png apple-icon-120x120.png apple-icon-144x144.png apple-icon-152x152.png apple-icon-180x180.png apple-icon-76x76.png apple-icon-72x72.png apple-icon-60x60.png apple-icon-57x57.png ms-icon-144x144.png)
