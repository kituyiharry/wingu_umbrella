<template>
  <div>
    <v-slide-x-transition>
      <v-card v-show='showSection' class='ma-0' :id='section.name.split(" ")[0].concat(secindex)' 
        ...
        <v-card-title d-flex>
          ...
          <v-spacer></v-spacer>
          <v-menu attach transition='slide-y-reverse-transition' :nudge-left='180' 
        ...
        <v-card-actions>
          <v-spacer></v-spacer>
          <v-btn @click='handleCreateTimeout' small round color='red'>delete</v-btn>
        </v-card-actions>
      </v-card>
    </v-slide-x-transition>
