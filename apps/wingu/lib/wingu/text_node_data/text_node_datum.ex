defmodule Wingu.TextNodeData.TextNodeDatum do
  ...
  schema "text_node_data" do
    ...
    belongs_to :description_node, Wingu.DescriptionNodes.DescriptionNode,
      define_field: false,
      foreign_key: :description_nodes_id

    belongs_to :section_datum, Wingu.SectionData.SectionDatum,
      define_field: false,
